    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-head">
                        <a href="{{ url('/avatar/create') }}"><img src="/images/back_icon.png" class="back_icon">
                            ...
                            <div class="icon_container">
                                 <div class="upper_arrow">
                                    <a href="/avatar/create">
                                        <img src="/images/create/arrow_down.png">
                                    </a>
                                 </div>
                                 <div class="mid_arrow">
                                    <a href="/avatar/create">
                                        <img src="/images/create/arrow_left.png">
                                    </a>
                                    <h2>FRIZURE</h2>
                                    <a href="/avatar/shirt">
                                        <img src="/images/create/arrow_right.png">
                                    </a>
                                 </div>
                                @if(Session::get('gender') == 'male')
                                   <img src="/images/create/hair_male.png">
                                @else
